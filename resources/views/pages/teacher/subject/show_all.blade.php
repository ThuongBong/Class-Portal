                        ...
                        @if (!$subjects->isEmpty())
                            ...
                            @foreach($subjects as $i=>$subject)
                                <tr>
                                    ...
                                    <td style="vertical-align: middle"><a href="{{'class/'. $subject->classId}}" target="_blank">{{ $subject->className }}</a></td>
                                    ...
                                    <td style="vertical-align: middle;" class="btn-fix">
                                        <a href="{{ url('subject/form') }}" class="btn btn-success btn-sm"><i class="fa fa-fw fa-eye"></i></a>
                                        ...
                                        <a class="btn btn-danger btn-sm btn-delete btn-confirm-delete"
                                           ...
                                           onclick="return confirm('You want delete subject {{$subject->name}} in class: {{ $subject->className }}')"
                                        >
