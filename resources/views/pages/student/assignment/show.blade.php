...
@section('content')
    <div class="container" id="sessionDetailContainer" data-classid="66" data-courseid="42" data-classsize="16" data-classname="T2108M-APHL-Year2022">
        <ul class="breadcrumb none-list mg-0 mg-b-25 fs-14 text-normal">
            ...
            <li>
                <a href="" class="text-decoration-none" title="Subject Name">
                    {{ $subject->name }}
                </a>
            </li>
            <li class="separator">/</li>
                                            ...
                                            <div class="lesson-item-thumb fs-14 text-lightbold">
                                                ...
                                                <div class="lessons-title lessons-title-sub acivity-sub-item text-normal">
                                                    <a class="activity-sum text-decoration-none" href="{{route('student.assignment.show-details', $assignment->id)}}" title="Title Assignment">
                                                        ...
                                                        <span class="activity-name mg-b-10" style="font-size: 13px; color: var(--text-color);">
                                                            Due Date: {{$assignment->due_date}}
                                                        </span>
                                                        <span class="activity-state-label pending" style="font-size: 13px">
